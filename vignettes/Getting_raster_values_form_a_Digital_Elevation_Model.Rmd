...
Now we need to import our regional DEM model. These are usually in the Raster format and we have included one in the package for use in examples. 

```{r}
DEM30_BK=Kulan::DEM30_BK
```
